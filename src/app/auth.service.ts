...
export class AuthService {
    ...
    private restAuthUrlLogin = 'http://fractal-django-prod.herokuapp.com//rest-auth/login/';
    private restAuthUrlLogout = 'http://fractal-django-prod.herokuapp.com//rest-auth/logout/';
    private restAuthUrlSignup = 'http://fractal-django-prod.herokuapp.com//rest-auth/registration/';
    private restAuthUrlChangePassword = 'http://fractal-django-prod.herokuapp.com//rest-auth/password/change/';
    private restAuthUrlLoginNew = 'http://fractal-django-prod.herokuapp.com//api/auth/token/';
